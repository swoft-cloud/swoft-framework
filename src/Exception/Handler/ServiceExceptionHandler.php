...
/**
 * the handler of service exception
 *
 * @uses      ServiceExceptionHandler
 * @version   2017年12月10日
 * @author    stelin <phpcrazy@126.com>
 * @copyright Copyright 2010-2016 swoft software
 * @license   PHP Version 7.x {@link http://www.php.net/license/3_0.txt}
 */
class ServiceExceptionHandler extends AbstractHandler
{
    /**
    ...
    {
        return $this->getException() instanceof ServiceException;
    }
